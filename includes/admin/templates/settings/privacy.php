<table class="form-table">
    ...
    <tr valign="top">
        <td scope="row" colspan="2"><?php echo sprintf( __( 'If you want to delete visitor data, please <a href="%s">click here</a>.', 'wp-statistics' ), Menus::admin_url( 'optimization', array( 'tab' => 'purging' ) ) ); ?></td>
    </tr>
